...
class apples extends Site_controller {
  ...
  public function index ($offset = 0) {
    ...
    $limit = 25;
    $total = $model::count (array ('conditions' => $conditions));
    ...
    $fleas = $model::find ('all', array ('offset' => $offset, 'limit' => $limit, 'order' => 'id DESC', 'conditions' => $conditions));
    
    $this->load_view (array ('pagination' => $pagination, 'fleas' => $fleas, 'qs' => $qs));
  }
}
